...
if("TRUE" STREQUAL "TRUE")
  set(test_SOURCE_PREFIX /home/hjd/FIRE_ws/src/test)
  set(test_DEVEL_PREFIX /home/hjd/FIRE_ws/devel)
  set(test_INSTALL_PREFIX "")
  set(test_PREFIX ${test_DEVEL_PREFIX})
else()
  set(test_SOURCE_PREFIX "")
  set(test_DEVEL_PREFIX "")
  set(test_INSTALL_PREFIX /home/hjd/FIRE_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'test' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hjd/FIRE_ws/src/test/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT test_NUM_DUMMY_TARGETS)
      set(test_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::test::wrapped-linker-option${test_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR test_NUM_DUMMY_TARGETS "${test_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::test::wrapped-linker-option${test_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND test_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/hjd/FIRE_ws/devel/lib;/opt/ros/melodic/lib)
